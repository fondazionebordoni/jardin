...
public class EventList {
  ...
  public static final EventType ChangeSearchView = new EventType();

  public static final EventType ChangeTabFromGrid = new EventType();

  public static final EventType CheckUser = new EventType();

  public static final EventType CommitChanges = new EventType();
  ...
  public static final EventType SaveGridView = new EventType();
  ...
  public static final EventType ShowPieChart = new EventType();

  public static final EventType UpdateColumnModel = new EventType();

  public static final EventType UpdateStore = new EventType();

  public static final EventType UpdateTemplates = new EventType();
